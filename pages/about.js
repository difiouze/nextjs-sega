      ...
      <div className={styles.grid}>
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <b>Graphics:</b> VDP (Video Display Processor) derived from
                ...
                <ul>
                  <li>
                    ...
                    for background only) from a palette of 64 (can also show 64
          ...
          <li>
            ...
            <ul>
              <li>
                <b>Sound (PSG):</b> Texas Instruments SN76489 (note that the
                Sega Master System, Game Gear, and Mega Drive used a slightly
                altered clone of the newer SN76489A, while the older SG-series
                used the original SN76489)
                <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Japanese and South Korean consoles used 44-pin cartridges,
                    the same shape as SG-1000 cartridges
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Unused, pinout compatible with 50-pin cartridges (but
                    opposite gender) in all regions
                  </li>
                </ul>
              </li>
            </ul>
